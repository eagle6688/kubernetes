...
copytodir "$dir_gitlocal_kubernates/config" "$dir_install_service"
copytodir "$dir_gitlocal_kubernates/apiserver" "$dir_install_service"
copytodir "$dir_gitlocal_kubernates/controller-manager" "$dir_install_service"
copytodir "$dir_gitlocal_kubernates/scheduler" "$dir_install_service"
